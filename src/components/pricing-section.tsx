				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto justify-items-center">
					{plans.map((plan, index) => (
						...
						>
							...
							<Card
								className={`w-full max-w-md relative h-full ${
									plan.popular
										? "border-2 border-transparent bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-950/50 dark:to-purple-950/50 shadow-2xl"
										: "border shadow-lg bg-white dark:bg-slate-900"
								} hover:shadow-2xl transition-all duration-500 hover:scale-105 overflow-hidden`}
							>
								{plan.popular && (
								...
								<CardHeader className="text-center pb-8">
									<div
										className={`w-16 h-16 mx-auto rounded-full bg-gradient-to-r ${plan.gradient} p-4 mb-4`}
									>
